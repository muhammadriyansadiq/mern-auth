...
<div className=' min-[320px]:h-[620px] min-[1024px]:h-[634px] w-4/12  left flex flex-col justify-around max-[768px]:w-full'>
  ...
  <div className=' w-full flex justify-center items-center  mt-[10px]'>
    <p className=' w-4/12 bg-[#C1C1C1] h-[1px] flex justify-center items-center max-[320px]:w-5/12'></p><p className=' flex justify-center items-center h-[1px] w-1/12'>Or</p><p className='bg-[#C1C1C1] w-4/12 flex justify-center items-center h-[1px] max-[320px]:w-4/12'></p>
  </div>
...
placeholder='Confirm Password'
 className=' w-7/12 border-y-[1px]  border-e-[1px] border-solid focus:outline-none  focus:border-s-[2px] focus:border-[#2363ab] focus:border-e-[2px] focus:border-y-[2px] max-[768px]:w-9/12'/>
  ...
  <button type='submit' className=' min-[320px]:mt-[7px] flex justify-center w-full min-[1024px]:mt-[10px]'>
    <p className=' w-8/12 flex cursor-pointer items-center justify-center bg-[#3c5a9a] text-white p-[10px] rounded-lg'>
   <p> <span className=' font-bold'>Register Now!</span> </p>
    </p>
  </button>
  ...
  <div className=' min-[320px]:translate-y-[4px] w-full flex justify-center min-[1024px]:mt-[0px] min-[768px]:translate-y-[0px]'>
    <p className=' text-sm text-gray-400'>Already have an account?<Link to={'/login'} className=' text-[#2363ab]'> Sign In!</Link></p>
  </div>
  <p className=' text-center font-semibold  min-[769px]:block min-[768px]:translate-y-[6px]'>© 2024 Apna Connection</p>
</div>


<div className=' overflow-hidden min-[320px]:hidden min-[1024px]:block h-full w-8/12 right max-[768px]:w-full'>
    <img className='overflow-hidden w-full h-[704px]' src="https://www.apnaconnection.com/public/admin-panel/img/register-banner.jpg" alt="" />
</div>
