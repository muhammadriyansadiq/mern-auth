    ...
    <div className=" h-full w-full">
      <div className=" h-full w-full flex justify-between overflow-hidden max-[768px]:flex-col">
        <div className=" xs:h-[38.75rem] lg:h-[39.635rem] w-4/12  left flex flex-col justify-around max-[768px]:w-full">
          ...
          <form onSubmit={hadlesignin}>
            <div className="  flex justify-center w-full  ">
              <div className=" rounded-s-lg w-1/12 flex items-center justify-center border-y-[1px]  border-s-[1px] border-solid h-[2.5rem]"></div>
              <input
                type="email"
                aria-label="name"
            ...
            <button
              type="submit"
              className=" xs:mt-[29px] flex justify-center w-full"
            >
              <p className="w-9/12 ">
                <p className=" flex cursor-pointer items-center justify-center bg-[#2555A0] text-white p-[0.625rem] rounded-lg">
          ...
          <div className=" xs:mt-[0px] w-full flex justify-center">
            <p className=" text-sm">
              New Apna Connection
              <Link to={"/register"} className="text-[#2363ab]">
                {" "}
                Sign Up!
              </Link>
            </p>
          </div>
          <p className=" text-center hidden md:block  lg:translate-y-[4.9rem] ">
        ...
        <div className=" xs:hidden lg:block h-full w-8/12 right ">
          <img
            className=" w-full h-[43.9rem]"
            src="https://www.apnaconnection.com/public/admin-panel/img/login_banner.jpg"
            alt=""
          />
        </div>
      </div>
